import  homeomg from "../assets/hero.png"
const Home = () => {
  return (
    <section
    id="home"
  ...
  >
    ...
    <div className="w-full md:w-1/2 space-y-2">
      {/* Star badge */}
      <div className="flex items-end gap-3 bg-gray-50 w-fit1 px-4 py-2 rounded-full hover:bg-gray-100 transition-colors cursor-pointer group">
